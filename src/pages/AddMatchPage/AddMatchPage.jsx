  ...
  const onSubmit = async data => {
    ...
    if (data.isTeamGame) {
      ...
      if (playersWithTeams.length === 0) {
        toast.error('Por favor asigna equipos a los jugadores');
        return;
      }
    }
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          {selectedGame ? (
              ...
              <SelectedGame>
                ...
                <GameInfo>
                  ...
                  <GameMeta>
                    ...
                    jugadores • {selectedGame.playingTime}min
                  </GameMeta>
                </GameInfo>
              </SelectedGame>
              <Button
            ...
            <GameSearchContainer>
              ...
              {isFetchingGames && debouncedGameQuery.length >= 3 && (
                <SearchStatus>Buscando juegos...</SearchStatus>
              )}

              {gameSearchError && (
                <SearchStatus $error>{gameSearchError}</SearchStatus>
              )}
        ...
        <Section>
          ...
          <InputGroup>
            ...
            <Input
              ...
              {...register('duration', {
                ...
                min: {
                  value: 1,
                  message: 'La duración debe ser al menos de 1 minuto'
                }
              })}
              placeholder="60"
            />
          ...
          <CheckboxGroup>
            ...
            <CheckboxLabel
              htmlFor="cooperative"
              style={{ opacity: isTeamGame ? 0.5 : 1 }}
            >
              Juego cooperativo
            </CheckboxLabel>
          </CheckboxGroup>
          ...
          <CheckboxGroup>
            ...
            <CheckboxLabel
              htmlFor="teamGame"
              style={{ opacity: isCooperative ? 0.5 : 1 }}
            >
              Juego en equipos
            </CheckboxLabel>
          </CheckboxGroup>
          ...
          <InputGroup>
            ...
            <TextArea
              {...register('notes')}
              placeholder="Añade notas adicionales acerca de la partida..."
              rows={3}
            />
          </InputGroup>
        </Section>
                  ...
                  <PlayerInfo>
                    ...
                    <div>
                      ...
                      {shouldShowSyncButton(field) && (
                        <SyncButton
                          type="button"
                          onClick={() => handleGuestSync(field, index)}
                        >
                          Sincronizar
                        </SyncButton>
                      )}
